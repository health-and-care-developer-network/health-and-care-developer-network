...
public class ObjectJsonSchema<V> extends AbstractToString implements JsonSchema<V>
{
	private final ArrayConstructor<V> schema;

	@SuppressWarnings({"unchecked", "RedundantCast"})
	public ObjectJsonSchema(@NotNull final ObjectRootArrayConstructor<V> schema)
	{
