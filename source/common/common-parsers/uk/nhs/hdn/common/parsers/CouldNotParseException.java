...
{
	public CouldNotParseException(final long offset, @NonNls @NotNull final String because)
	{
		super(format(ENGLISH, "Could not parse at offset %1$s because %2$s", offset, because));
	}

	public CouldNotParseException(final long offset, @NotNull final Exception cause)
	{
