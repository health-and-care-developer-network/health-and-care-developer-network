...
import static uk.nhs.hdn.dbs.response.parsing.parsers.ResponseTrailerSingleLineFixedWidthParser.ResponseTrailerFieldsIndex;

public final class ResponseTrailerFixedWidthLineUser extends AbstractFixedWidthLineUser<ResponseTrailer>
{
	...
	{
		return ResponseTrailerFieldsIndex.get(key);
	}

	@NotNull
	public static final FixedWidthLineUser<ResponseTrailer> ResponseTrailerFixedWidthLineUserInstance = new ResponseTrailerFixedWidthLineUser();

	private ResponseTrailerFixedWidthLineUser()
	{
	}

	@NotNull
	@Override
	public ResponseTrailer use(final int zeroBasedLineIndex, @NotNull final Object... collectedFields) throws CouldNotConvertFieldsException
	{
		return new ResponseTrailer
		(
