...
public final class GroupName extends AbstractUniqueName implements GroupKey
{
	@FieldTokenName
	@NonNls
	@NotNull
	private static final String Field = "groupName";
	...
	@NotNull
	public static SeparatedValueSerialiser csvSerialiserForGroupNames(final boolean writeHeaderLine)
	{
		return commaSeparatedValueSerialiser(SeparatedValuesSchema, writeHeaderLine, SeparatedValuesHeadings);
	}

	@NotNull
	public static SeparatedValueSerialiser tsvSerialiserForGroupNames()
	{
		return tabSeparatedValueSerialiser(SeparatedValuesSchema, true, SeparatedValuesHeadings);
	}

	public GroupName(@NonNls @NotNull final String value)
	{
		super(value);
	}
}
