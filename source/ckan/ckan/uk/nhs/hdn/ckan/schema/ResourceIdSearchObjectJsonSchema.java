...
import static uk.nhs.hdn.ckan.schema.arrayCreators.SearchResultArrayCreator.SearchResultResourceIdArray;
...
public final class ResourceIdSearchObjectJsonSchema extends ObjectJsonSchema<SearchResult<ResourceId>>
{
	@SuppressWarnings("unchecked")
	@NotNull
	public static final ObjectRootArrayConstructor<SearchResult<ResourceId>> ResourceIdSearchSchema = rootIsObjectOf
	(
		SearchResultResourceIdArray,
		object
		(
			SearchResult.class,
			nonNulllongField(countField),
			nonNullField(resultsField, ValueSerialisable[].class, convertUsingDelegateListCollectingStringArrayConstructor(ResourceIdArray, ResourceId.class, "valueOf"))
		)
	);

	@NotNull
	public static final ObjectJsonSchema<SearchResult<ResourceId>> ResourceIdSearchSchemaInstance = new ResourceIdSearchObjectJsonSchema();

	private ResourceIdSearchObjectJsonSchema()
	{
		super(ResourceIdSearchSchema);
	}
