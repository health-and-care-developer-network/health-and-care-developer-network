...
public final class RevisionIdsArrayJsonSchema extends ArrayJsonSchema<RevisionId>
{
	@NotNull
	public static final ArrayRootArrayConstructor<RevisionId> RevisionIdsSchema = rootIsArrayOf
	(
		RevisionIdArray,
		convertUsingDelegateListCollectingStringArrayConstructor(RevisionIdArray, RevisionId.class, "valueOf")
	);

	@NotNull
	public static final ArrayJsonSchema<RevisionId> RevisionIdsSchemaInstance = new RevisionIdsArrayJsonSchema();

	private RevisionIdsArrayJsonSchema()
	{
		super(RevisionIdsSchema);
	}
