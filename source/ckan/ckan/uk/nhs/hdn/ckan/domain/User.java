...
public final class User implements ValueSerialisable
{
	...
	public final int numberOfEdits;
	public final int numberOfAdministeredPackages;
	...
	public User(@Nullable final OpenId openId, @Nullable @NonNls final String about, @NotNull final Status status, @NotNull final UserName userName, @NotNull final MicrosecondTimestamp created, @NotNull final Hash emailHash, final int numberOfEdits, final int numberOfAdministeredPackages, @NotNull @NonNls final String displayName, @NotNull @NonNls final String fullName, @NotNull final UserId id)
	{
		this.openId = openId;
		this.about = about;
		this.status = status;
	...
	public int hashCode()
	{
		...
		result = 31 * result + numberOfEdits;
		result = 31 * result + numberOfAdministeredPackages;
