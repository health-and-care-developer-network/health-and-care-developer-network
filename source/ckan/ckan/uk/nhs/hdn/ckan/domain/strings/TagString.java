...
public final class TagString extends AbstractSerialisableString
{
	@FieldTokenName
	@NonNls
	@NotNull
	...
	@NotNull
	public static SeparatedValueSerialiser csvSerialiserForTags(final boolean writeHeaderLine)
	{
	...
	public TagString(@NonNls @NotNull final String value)
	{
		super(value);
	}
}
