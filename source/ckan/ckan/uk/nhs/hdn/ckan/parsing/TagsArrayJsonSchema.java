...
import static uk.nhs.hdn.ckan.parsing.TagArrayCreator.TagArray;
import static uk.nhs.hdn.common.parsers.json.jsonParseEventHandlers.constructors.arrayConstructors.root.NonNullArrayRootArrayConstructor.rootIsArrayOf;
	...
	public final class TagsArrayJsonSchema extends ArrayJsonSchema<TagString>
{
	@NotNull
	public static final ArrayRootArrayConstructor<TagString> TagsSchema = rootIsArrayOf
	(
		TagArray,
		new AbstractListCollectingStringArrayConstructor<TagString>(TagArray)
		{
			@Override
			public void addConstantStringValue(@NotNull final List<TagString> arrayCollector, final int index, @NotNull final String value)
			{
				arrayCollector.add(new TagString(value));
			}
		}
	);

	@NotNull
	public static final ArrayJsonSchema<TagString> TagsSchemaInstance = new TagsArrayJsonSchema();
