...
import static uk.nhs.hdn.ckan.schema.arrayCreators.GroupNameArrayCreator.GroupNameArray;
...
public final class GroupNamesArrayJsonSchema extends ArrayJsonSchema<GroupName>
{
	@NotNull
	public static final ArrayRootArrayConstructor<GroupName> GroupNamesSchema = rootIsArrayOf
	(
		GroupNameArray,
		convertUsingDelegateListCollectingStringArrayConstructor(GroupNameArray, GroupName.class)
	);

	@NotNull
	public static final ArrayJsonSchema<GroupName> GroupNamesSchemaInstance = new GroupNamesArrayJsonSchema();
