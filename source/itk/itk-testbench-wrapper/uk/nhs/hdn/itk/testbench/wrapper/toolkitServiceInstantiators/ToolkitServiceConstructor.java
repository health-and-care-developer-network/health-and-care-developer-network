...
public interface ToolkitServiceConstructor<S extends ToolkitService>
{
	@NotNull
	S instantiate(@NotNull final GenericToolkitServiceInstantiator genericToolkitServiceInstantiator) throws CouldNotInstantiateToolkitServiceException;
}
