...
{
	@NotNull
	ApiMethod<SimplePatientRecord> simplePatientRecord(@SuppressWarnings("TypeMayBeWeakened") @NotNull final NhsNumber nhsNumber);

	@NotNull
	ApiMethod<ProviderMetadataRecord> providerMetadataRecord(@NotNull final ProviderIdentifier providerIdentifier);
