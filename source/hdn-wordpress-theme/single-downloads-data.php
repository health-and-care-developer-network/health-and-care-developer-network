	 						...
	 						<?php while(has_sub_field('file_download')): ?>
								<div class="download_item">
									...
									<p><?php the_sub_field('file_size'); ?></p>
								 	<a href="<?php the_sub_field('file'); ?>" class="btn red_btn dl_btn">Download Now <span class="btn_icon" aria-hidden="true" data-icon="&#x6c;"></span></a>
									<div class="clear"></div>
						...
						<?php if(get_field('file_download_link')): ?>
	 						<?php while(has_sub_field('file_download_link')): ?>
								<div class="download_item">
								 	<h4><?php the_sub_field('file_name'); ?></h4>
									<p><?php the_sub_field('file_size'); ?></p>
								 	<a href="<?php the_sub_field('file_link'); ?>" class="btn red_btn dl_btn" target="_blank">Download Now <span class="btn_icon" aria-hidden="true" data-icon="&#x6c;"></span></a>
									<div class="clear"></div>
									<p class="sm_print"><?php the_sub_field('terms'); ?></p>
								</div>	
							<?php endwhile; ?> 
