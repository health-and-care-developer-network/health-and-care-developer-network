		...
		<div class="wrapper cf container">
			<div class="one_quarter tree_wrap">
				<div class="left_bar_list">
					<h3>Categories</h3>
					<ul>
					<?php wp_list_categories('taxonomy=learning-categories&orderby=name&show_count=1&title_li='); ?></ul>
							...
							<div class="three_quarters art_txt_area">
								<hgroup>
									...
									<ul class="blog_meta cf">
										...
										<li class="tags"><span class="meta_icon" aria-hidden="true" data-icon="&#x2e;"></span><?php the_tags('', ', ' ,''); ?></li>
									</ul>
								</hgroup>
