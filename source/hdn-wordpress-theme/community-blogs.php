 <?php
/*
Template Name: z_Community Blogs
*/
?>
				...
				<div class="wrapper cf container">
					...
					<div class="three_quarters">
						<div class="content_wrap">
							...
							<?php query_posts( array( 'post_type' => 'community', 'community-type' => 'community-blog' ) ); ?>
							<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
								...
								<article class="blog_post cf">
									...
									<?php the_excerpt(); ?>
									<a href="<?php the_permalink(); ?>" class="btn aquaGreen_btn">Read Blog <span class="btn_icon" aria-hidden="true" data-icon="&#x29;"></span></a>
								</article>
