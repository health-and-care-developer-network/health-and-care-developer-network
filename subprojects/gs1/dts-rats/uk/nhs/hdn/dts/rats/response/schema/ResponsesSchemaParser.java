...
import uk.nhs.hdn.dts.rats.response.details.KnownDetails;

import static uk.nhs.hdn.common.parsers.xml.xmlParseEventHandlers.xmlConstructors.ArrayXmlConstructor.arrayOf;
...
import static uk.nhs.hdn.dts.domain.schema.xmlConstructors.XmlSchemaDateTimeTextXmlConstructor.XmlSchemaDateTimeTextXmlConstructorInstance;
import static uk.nhs.hdn.dts.domain.statusRecords.dateTime.UnknownDateTime.UnknownDateTimeInstance;
import static uk.nhs.hdn.dts.rats.response.FailureDiagnostic.UnknownDiagnostic;
import static uk.nhs.hdn.dts.rats.response.details.UnknownDetails.UnknownDetailsInstance;
import static uk.nhs.hdn.dts.rats.response.schema.FailureDiagnosticTextXmlConstructor.FailureDiagnosticTextXmlConstructorInstance;
import static uk.nhs.hdn.dts.rats.response.schema.MessageIdentifierTextXmlConstructor.MessageIdentifierTextXmlConstructorInstance;
import static uk.nhs.hdn.dts.rats.response.schema.ResponseArrayCreator.ResponseArrayCreatorInstance;
import static uk.nhs.hdn.dts.rats.response.schema.ResponseStatusTextXmlConstructor.ResponseStatusTextXmlConstructorInstance;
import static uk.nhs.hdn.dts.rats.response.schema.StatusValueTextXmlConstructor.StatusValueTextXmlConstructorInstance;
