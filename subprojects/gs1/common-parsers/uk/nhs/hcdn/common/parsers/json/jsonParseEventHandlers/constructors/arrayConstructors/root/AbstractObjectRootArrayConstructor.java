...
import uk.nhs.hcdn.common.parsers.json.jsonParseEventHandlers.schemaViolationInvalidJsonExceptions.NullObjectValueNotAllowedForSchemaViolationInvalidJsonException;
import uk.nhs.hcdn.common.parsers.json.jsonParseEventHandlers.schemaViolationInvalidJsonExceptions.ObjectValueTypeMismatchForSchemaViolationInvalidJsonException;
...
import uk.nhs.hcdn.common.parsers.json.jsonParseEventHandlers.schemaViolationInvalidJsonExceptions.UnexpectedArrayValueForSchemaViolationInvalidJsonException;

public abstract class AbstractObjectRootArrayConstructor<V> extends AbstractRootArrayConstructor<V>
{
	@NotNull
	...
	protected AbstractObjectRootArrayConstructor(@NotNull final Class<V> vClass, final boolean nullPermitted, @NotNull final ArrayCreator<V> arrayCreator, @NotNull final ObjectConstructor<?> objectConstructor)
	{
		this.vClass = vClass;
