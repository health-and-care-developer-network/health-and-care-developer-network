...
public abstract class AbstractObjectsOnlyForElementsArrayConstructor<X> implements ArrayConstructor<List<X>>
{
	@NotNull
	private final Class<X> xClass;
	private final boolean nullDisallowed;

	protected AbstractObjectsOnlyForElementsArrayConstructor(@NotNull final Class<X> xClass, final boolean nullPermitted)
	{
		this.xClass = xClass;
