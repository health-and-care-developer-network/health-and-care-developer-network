...
public abstract class AbstractListCollectingLongNumberArrayConstructor<X> extends AbstractLongNumberArrayConstructor<List<X>>
{
	@NotNull
	private final ArrayCreator<X> arrayCreator;

	protected AbstractListCollectingLongNumberArrayConstructor(@NotNull final ArrayCreator<X> arrayCreator)
	{
