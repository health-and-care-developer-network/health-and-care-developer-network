...
public class NonNullArrayRootArrayConstructor<V> extends ArrayRootArrayConstructor<V>
{
	...
	{
		return new NonNullArrayRootArrayConstructor<>(arrayCreator, arrayConstructor);
	}

	public NonNullArrayRootArrayConstructor(@NotNull final ArrayCreator<V> arrayCreator, @NotNull final ArrayConstructor<?> arrayConstructor)
	{
