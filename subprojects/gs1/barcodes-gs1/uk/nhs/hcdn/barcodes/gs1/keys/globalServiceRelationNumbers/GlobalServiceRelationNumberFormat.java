...
public enum GlobalServiceRelationNumberFormat implements KeyFormat
{
	GSRN("Global Service Relation Number"),
	;
	public static final int MaximumOneBasedPositionT = 18;
	...
	GlobalServiceRelationNumberFormat(@NonNls @NotNull final String actualName, @NonNls @NotNull final String... formerActualNames)
	{
