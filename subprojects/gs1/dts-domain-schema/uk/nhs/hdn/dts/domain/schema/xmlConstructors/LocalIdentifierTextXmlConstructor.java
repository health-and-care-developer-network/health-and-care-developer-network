...
public final class LocalIdentifierTextXmlConstructor extends TextXmlConstructor<LocalIdentifier>
{
	@NotNull
	public static final XmlConstructor<?, ?> LocalIdentifierTextXmlConstructorInstance = new LocalIdentifierTextXmlConstructor();
	...
	@NotNull
	@Override
	protected LocalIdentifier convert(@NotNull final String text) throws XmlSchemaViolationException
	{
		try
		{
			return new LocalIdentifier(text);
		}
