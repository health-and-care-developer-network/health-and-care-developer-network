...
import uk.nhs.hcdn.common.tuples.Quadruple;
...
import static uk.nhs.hcdn.dts.domain.status.Event.*;
import static uk.nhs.hcdn.dts.domain.status.Status.ERROR;
import static uk.nhs.hcdn.dts.domain.status.Status.SUCCESS;
import static uk.nhs.hcdn.dts.domain.status.StatusCode.statusCode;
import static uk.nhs.hcdn.dts.domain.status.StatusType.*;
